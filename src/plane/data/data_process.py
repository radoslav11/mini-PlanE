...
class DataPlanE(tgdata.Data):
    """Definition of the data class for PlanE"""

    def __init__(self, **kwargs):
        super(DataPlanE, self).__init__(**kwargs)
...
def planar_preprocess(data: tgdata.Data, directional_tree=True):
    ...
    def add_bcc(tree: sageall.Graph, center, code):
        ...
        for node in tree.vertex_iterator():
            ...
            spqr_num_nodes += 1
            # Map SPQR type: S/Q->0, P->1, R->2
            spqr_type.append({"S": 0, "P": 1, "Q": 0, "R": 2}[node[0]])
